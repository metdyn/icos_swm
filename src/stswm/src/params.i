...
C
C      PARAMETER (MM=42, NN=42, KK=42, NLAT=64, NLON=128)
...
C     PARAMETER (MM=170, NN=170, KK=170, NLAT=256, NLON=512)
      PARAMETER (MM=213, NN=213, KK=213, NLAT=320, NLON=640)
C
...
C
C      PARAMETER (RTRUNC=42)
      PARAMETER (RTRUNC=213)
C
C     YGYU
      INTEGER    glvl, nip, niE
      PARAMETER (glvl=6)
      PARAMETER (nip=10*4**glvl+2)
CC     bc  nx * ny =  ( 10 * 2**(glvl-1) ) ** 2
CC      PARAMETER (nip=100*4**glvl+2)   C__ too large, too big
      PARAMETER (niE=30*4**glvl  )
C
C***********************************************************************
C
